...
return content;};var init=function(plot){new FlotTooltip(plot);};$.plot.plugins.push({init:init,options:defaultOptions,name:'tooltip',version:'0.6.1'});})(jQuery);var ConstituentCurrentYearComparisonPlot=function(plotContainerSelector,series){if(!$(plotContainerSelector).length){;throw Error('Bar Chart could not find element with jquery selector "'+plotContainerSelector+'".');}
var plotContainer=$(plotContainerSelector);var plotClass=ConstituentCurrentYearComparisonPlot.plotClass;var plotDiv=$('<div/>',{'class':plotClass});;var plotDivSelector=plotContainerSelector+' .'+plotClass;plotContainer.append(plotDiv);var legendClass=ConstituentCurrentYearComparisonPlot.legendClass;var legendDiv=$('<div/>',{'class':legendClass});var legendDivSelector=plotContainerSelector+' .'+legendClass;plotContainer.append(legendDiv);var yearSeries={data:[['',series.yearValue]],label:'2014',bars:{show:true,barWidth:0.4,align:"right",fillColor:series.yearColor}};var averageSeries={data:[['',series.averageValue]],label:'Average 1990-2013',bars:{show:true,barWidth:0.4,align:"left",fillColor:series.averageColor}};var flotSeries=[yearSeries,averageSeries];var plot=$.plot(plotDivSelector,flotSeries,{series:{bars:{show:true,barWidth:0.6,align:"center"}},xaxis:{mode:"categories",tickLength:0,axisLabel:series.constituentName},yaxis:{axisLabel:series.constituentUnit,axisLabelUseCanvas:true,axisLabelPadding:3},grid:{hoverable:true,clickable:true},colors:[series.yearColor,series.averageColor],tooltip:true,tooltipOpts:{content:'%s: %y '+series.constituentUnit},legend:{container:legendDivSelector||null}});return plot;};ConstituentCurrentYearComparisonPlot.legendClass='currentYearComparisonLegend';ConstituentCurrentYearComparisonPlot.plotClass='currentYearComparisonPlot';$(document).ready(function(){var nitrateSeries={constituentName:'Total Phosphorous',constituentUnit:'Million kg',yearValue:12,yearColor:'rgb(0,255,0)',averageValue:10,averageColor:'rgb(0,155,0)'};var nitrateGraph=ConstituentCurrentYearComparisonPlot('#barChart2',nitrateSeries);var phosphorousSeries={constituentName:'Total Nitrate',constituentUnit:'Million kg',yearValue:100,yearColor:'rgb(255,0,0)',averageValue:153,averageColor:'rgb(155,0,0)'};var phosphorousGraph=ConstituentCurrentYearComparisonPlot('#barChart3',phosphorousSeries);var streamflowSeries={constituentName:'Streamflow',constituentUnit:'Million acre-feet',yearValue:1.7,yearColor:'rgb(0,0,255)',averageValue:2.4,averageColor:'rgb(0,0,155)'};var streamflowGraph=ConstituentCurrentYearComparisonPlot('#barChart1',streamflowSeries);var streamflowSeries={constituentName:'Suspended Sediment',constituentUnit:'Million kg',yearValue:324098.56,yearColor:'#CC6600',averageValue:894904.8,averageColor:'#8F4700'};var streamflowGraph=ConstituentCurrentYearComparisonPlot('#barChart4',streamflowSeries);});