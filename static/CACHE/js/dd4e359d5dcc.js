...
return content;};var init=function(plot){new FlotTooltip(plot);};$.plot.plugins.push({init:init,options:defaultOptions,name:'tooltip',version:'0.6.1'});})(jQuery);var ConstituentCurrentYearComparisonPlot=function(plotContainerSelector,series,legendSelector){nar.util.assert_selector_present(plotContainerSelector);if(legendSelector){nar.util.assert_selector_present(legendSelector);}
var averageColor=series.averageColor||ConstituentCurrentYearComparisonPlot.defaultAverageColor;var plotContainer=$(plotContainerSelector);var plotClass=ConstituentCurrentYearComparisonPlot.plotClass;var plotDiv=$('<div/>',{'class':plotClass});var plotDivSelector=plotContainerSelector+' .'+plotClass;plotContainer.append(plotDiv);var titleClass=ConstituentCurrentYearComparisonPlot.titleClass;var titleDiv=$('<div/>',{'class':titleClass});titleDiv.html(series.constituentName);var titleDivSelector=plotContainerSelector+' .'+titleClass;plotContainer.append(titleDiv);if(!legendSelector){var legendClass=ConstituentCurrentYearComparisonPlot.legendClass;var legendDiv=$('<div/>',{'class':legendClass});legendSelector=plotContainerSelector+' .'+legendClass;plotContainer.append(legendDiv);}
var yearSeries={data:[['',series.yearValue]],label:'2014',bars:{show:true,barWidth:0.4,align:"left",fillColor:series.yearColor}};var averageSeries={data:[['',series.averageValue]],label:series.averageName,bars:{show:true,barWidth:0.4,align:"right",fillColor:averageColor}};var flotSeries=[averageSeries,yearSeries];var plot=$.plot(plotDivSelector,flotSeries,{series:{bars:{show:true,barWidth:0.6,align:"center"}},xaxis:{mode:"categories",tickLength:0},yaxis:{axisLabel:series.displayUnitOnYAxis?series.constituentUnit:null,axisLabelUseCanvas:true,axisLabelPadding:3},grid:{hoverable:true,clickable:true},colors:[averageColor,series.yearColor],tooltip:true,tooltipOpts:{content:'%s: %y '+series.constituentUnit},legend:{container:legendSelector||null}});return plot;};ConstituentCurrentYearComparisonPlot.defaultAverageColor='#D8DCDC';ConstituentCurrentYearComparisonPlot.titleClass='currentYearComparisonTitle';ConstituentCurrentYearComparisonPlot.legendClass='currentYearComparisonLegend';ConstituentCurrentYearComparisonPlot.plotClass='currentYearComparisonPlot';$(document).ready(function(){var nutrientColor='#FF66FF';var nitrateSeries={constituentName:'Total Phosphorous',constituentUnit:'Million Tons',yearValue:12,yearColor:nutrientColor,averageName:'Average 1991-2013',averageValue:10};var nitrateGraph=ConstituentCurrentYearComparisonPlot('#barChart2',nitrateSeries,'#barChartLegend2');var phosphorousSeries={constituentName:'Nitrate',constituentUnit:'Million Tons',yearValue:100,yearColor:nutrientColor,averageName:'Average 1985-2013',averageValue:153};var phosphorousGraph=ConstituentCurrentYearComparisonPlot('#barChart3',phosphorousSeries,'#barChartLegend3');var streamflowSeries={constituentName:'Streamflow',constituentUnit:'Million acre-feet',yearValue:1.7,yearColor:'rgb(0,0,255)',averageName:'Average 1999-2013',averageValue:2.4};var streamflowGraph=ConstituentCurrentYearComparisonPlot('#barChart1',streamflowSeries,'#barChartLegend1');var sedimentSeries={constituentName:'Suspended Sediment',constituentUnit:'Million Tons',yearValue:300,yearColor:'#CC6600',averageName:'Average 1990-2013',averageValue:100};var streamflowGraph=ConstituentCurrentYearComparisonPlot('#barChart4',sedimentSeries,'#barChartLegend4');});